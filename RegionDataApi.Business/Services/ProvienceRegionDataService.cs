    ...
    public class ProvienceRegionDataService : IProvienceRegionDataService
    {
        ...
        public async Task SyncProvienceRegionDataAsync(int startYear, int endYear, int regionCode)
        {
            ...
            var reports = reportsObj["reports"]["report"]
                              .Children()
                              .Select(r => new ProvienceRegionDataDto
                              {
            ...
            foreach (var dto in reports)
            {
                ...
                await _repository.AddProvienceRegionDataAsync(new Tbl_ProvienceRegionData
                {
        ...
        public async Task SaveProvienceRegionDataAsync(ProvienceRegionDataDto dto)
        {
            if (dto == null)
            {
            ...
            var entity = new Tbl_ProvienceRegionData
            {
                RegionCode = dto.RegionCode,
                DataValue = dto.DataValue,
                RequestDate = dto.RequestDate,
        ...
        public async Task<ProvienceRegionDataDto> GetLatestProvienceByRegionCodeAsync(int regionCode)
        {
            ...
            return new ProvienceRegionDataDto
            {
